...
["dart.async", "dart:async", , P, {
  ...
  _SyncCompleter: {
    ...
    }, "complete$0", "call$1", "call$0", "get$complete", 0, 2, 13, 14]
  },
  _Future: {
...
["", "derp.dart", , K, {
  "^": "",
  main: [function() {
    var t1 = J.get$onClick$x(document.querySelector("#new_dude"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.new_employee$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#make_money"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.make_money$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    K.update_money(true);
  }, "call$0", "main$closure", 0, 0, 1],
  new_employee: [function($event) {
    var t1, t2, t3;
    t1 = $.get$office().$index(0, "funds");
    t2 = $.get$prices().$index(0, "employee");
    if (typeof t1 !== "number")
      return t1.$ge();
    if (typeof t2 !== "number")
      return H.iae(t2);
    if (t1 >= t2) {
      t1 = $.get$office();
      t2 = t1.$index(0, "funds");
      t3 = $.get$prices().$index(0, "employee");
      if (typeof t2 !== "number")
        return t2.$sub();
      if (typeof t3 !== "number")
        return H.iae(t3);
      t1.$indexSet(0, "funds", t2 - t3);
      K.update_money(false);
      J.add$1$ax($.get$office().$index(0, "employees"), new K.Employee(null));
      document.querySelector("#employees_num").textContent = C.JSInt_methods.toString$0(J.get$length$asx($.get$office().$index(0, "employees")));
    }
  }, "call$1", "new_employee$closure", 2, 0, 6],
  make_money: [function($event) {
    var t1, t2;
    t1 = $.get$office();
    t2 = t1.$index(0, "funds");
    if (typeof t2 !== "number")
      return t2.$add();
    t1.$indexSet(0, "funds", t2 + 100);
    K.update_money(false);
  }, "call$1", "make_money$closure", 2, 0, 6],
  update_money: function(future) {
    document.querySelector("#current_funds").textContent = J.toString$0($.get$office().$index(0, "funds"));
    if (future)
      P.Future_Future$delayed(C.Duration_1000000, new K.update_money_closure(), null);
  },
  Employee: {
    "^": "Object;name"
  },
  update_money_closure: {
    "^": "Closure:7;",
    call$0: function() {
      K.update_money(true);
    }
...
Isolate.$lazy($, "office", "office", "get$office", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["funds", $.Money, "employees", [], "departments", P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), "upgrades", []], null, null);
});
Isolate.$lazy($, "prices", "prices", "get$prices", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["employee", 100], null, null);
});
// Native classes
...
//# sourceMappingURL=derp.dart.js.map
{
  var message =
